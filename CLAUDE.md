...
| IDS files | 5 | `sting-tag-grammar.ids` (11 specs), `sting-spatial-codes.ids` (7 specs), `sting-drawing.ids` (6 specs), `sting-tag7.ids` (7 specs), `sting-project-org.ids` (6 specs) — 37 specs total across all 5 psets |
