...
> **52 of 89 entries are closed** on `claude/kibale-integration` — 8 partial, 1 held, 1 blocked, 3 recommend, 24 open. Generated by `tools/register_count.py` from the table rows — do not hand-edit, it has drifted three times when maintained by hand.
