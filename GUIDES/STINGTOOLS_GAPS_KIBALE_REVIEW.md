...
> **67 of 121 entries are closed** on `claude/kibale-integration` — 10 partial, 1 held, 2 blocked, 1 rule, 3 recommend, 37 open. Generated by `tools/register_count.py` from the table rows — do not hand-edit, it has drifted three times when maintained by hand.
