...
Every question that must be answered, who answers it, and what it blocks.
**Nothing here is rhetorical.** Each one changes what can be said or signed.

Status: `OPEN` · `ASKED` (waiting on someone) · `CLOSED` (answer recorded below)
...
### D-04 · What is demo-safe on the deployed build? — `OPEN`
