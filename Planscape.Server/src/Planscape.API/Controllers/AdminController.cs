...
public class AdminController : ControllerBase
{
    ...
    public async Task<ActionResult> UpdateUser(Guid userId, [FromBody] UpdateUserRequest req)
    {
        ...
        //
        // This became materially more reachable when demotion turned into the
        // seat-management tool ("free a seat by changing an author to Viewer") —
        // the obvious way to release a seat was also the way to brick the tenant.
