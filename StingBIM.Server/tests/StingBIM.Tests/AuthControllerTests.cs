...
public class AuthControllerTests : IClassFixture<StingBimWebApplicationFactory>
{
    private readonly StingBimWebApplicationFactory _factory;

    public AuthControllerTests(StingBimWebApplicationFactory factory) => _factory = factory;
