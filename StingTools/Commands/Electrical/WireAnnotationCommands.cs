...
namespace StingTools.Commands.Electrical
{
    ...
    internal static class WireAnnotationEngine
    {
        ...
        public static WireAnnotationData ReadWireData(Element conduit)
        {
            ...
            double csa       = ReadNumParam(conduit, "ELC_WIRE_CSA_MM2_NUM");
            double vd        = ReadNumParam(conduit, "ELC_WIRE_VD_PCT_NUM");
            ...
            double fill = ReadNumParam(conduit, "ELC_CDT_CBL_FILL_PCT");
