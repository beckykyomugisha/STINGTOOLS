...
namespace StingTools.Commands.Hvac
{
    ...
    public class HvacBlockLoadCommand : IExternalCommand
    {
        ...
        /// <summary>
        /// Best-effort envelope detection — delegates to the shared
        /// <see cref="StingTools.Core.Hvac.Loads.EnvelopeDetector"/> so the
        /// sustainability annual-energy path reuses the identical conduction +
        ...
        public static void InvalidateTopLevelCache(Document doc)
            => StingTools.Core.Hvac.Loads.EnvelopeDetector.InvalidateTopLevelCache(doc);
