...
namespace StingTools.Core.Drawing
{
    ...
    public static class TitleBlockFactory
    {
        ...
        public static TitleBlockBuildResult Build(Autodesk.Revit.UI.UIApplication uiApp,
        ...
        private static Autodesk.Revit.DB.HorizontalTextAlignment ParseHAlign(string s)
        {
            switch ((s ?? "").ToLowerInvariant())
            {
                case "right":  return Autodesk.Revit.DB.HorizontalTextAlignment.Right;
                case "center":
                case "centre": return Autodesk.Revit.DB.HorizontalTextAlignment.Center;
                default:       return Autodesk.Revit.DB.HorizontalTextAlignment.Left;
            }
        }

        private static Autodesk.Revit.DB.VerticalTextAlignment ParseVAlign(string s)
        {
            switch ((s ?? "").ToLowerInvariant())
            {
                case "top":    return Autodesk.Revit.DB.VerticalTextAlignment.Top;
                case "bottom": return Autodesk.Revit.DB.VerticalTextAlignment.Bottom;
                default:       return Autodesk.Revit.DB.VerticalTextAlignment.Middle;
            }
        }
    }
}
