...
namespace StingTools.Core.Drawing
{
    ...
    public static class ViewStylePackApplier
    {
        ...
        private static ElementId ResolveFilterIdCached(Document doc, string filterName)
        {
            ...
            catch (Exception ex) { StingLog.Warn($"Suppressed: {ex.Message}"); resolved = ElementId.InvalidElementId; }
        ...
        internal static void ApplyCategoryOverrides(Document doc, View view, ViewStylePack pack, PackApplyResult r)
        {
            ...
            foreach (var kv in pack.VgOverrides)
            {
                try
                {
                    ...
                    {
                        try { view.SetCategoryHidden(catId, !src.Visible.Value); } catch (Exception ex) { StingLog.Warn($"Suppressed: {ex.Message}"); }
                    }
                    ...
                    if (!string.IsNullOrEmpty(src.SurfaceFgPattern))
                    {
                        ...
                        if (fid != ElementId.InvalidElementId)
                        {
                            ...
                            try { ogs.SetSurfaceForegroundPatternVisible(src.SurfaceFgVisible ?? true); } catch (Exception ex) { StingLog.Warn($"Suppressed: {ex.Message}"); }
                        }
                    }
                    else if (src.SurfaceFgVisible.HasValue)
                    {
                        try { ogs.SetSurfaceForegroundPatternVisible(src.SurfaceFgVisible.Value); } catch (Exception ex) { StingLog.Warn($"Suppressed: {ex.Message}"); }
                    }
                    ...
                    if (!string.IsNullOrEmpty(src.SurfaceBgPattern))
                    {
                        ...
                        if (fid != ElementId.InvalidElementId)
                        {
                            ...
                            try { ogs.SetSurfaceBackgroundPatternVisible(src.SurfaceBgVisible ?? true); } catch (Exception ex) { StingLog.Warn($"Suppressed: {ex.Message}"); }
                        }
                    }
                    else if (src.SurfaceBgVisible.HasValue)
                    {
                        try { ogs.SetSurfaceBackgroundPatternVisible(src.SurfaceBgVisible.Value); } catch (Exception ex) { StingLog.Warn($"Suppressed: {ex.Message}"); }
                    }
                    ...
                    if (!string.IsNullOrEmpty(src.CutFgPattern))
                    {
                        ...
                        if (fid != ElementId.InvalidElementId)
                        {
                            ...
                            try { ogs.SetCutForegroundPatternVisible(src.CutFgVisible ?? true); } catch (Exception ex) { StingLog.Warn($"Suppressed: {ex.Message}"); }
                        }
                    }
                    else if (src.CutFgVisible.HasValue)
                    {
                        try { ogs.SetCutForegroundPatternVisible(src.CutFgVisible.Value); } catch (Exception ex) { StingLog.Warn($"Suppressed: {ex.Message}"); }
                    }
                    ...
                    if (src.Transparency.HasValue)
                    {
                        ...
                        if (t >= 100)
                        {
                            try { ogs.SetSurfaceForegroundPatternVisible(false); } catch (Exception ex) { StingLog.Warn($"Suppressed: {ex.Message}"); }
                            try { ogs.SetSurfaceBackgroundPatternVisible(false); } catch (Exception ex) { StingLog.Warn($"Suppressed: {ex.Message}"); }
                        }
                    }
            ...
            foreach (var rule in pack.Filters)
            {
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(sfgPattern))
                    {
                        ...
                        {
                            ogs.SetSurfaceForegroundPatternId(fid);
                            try { ogs.SetSurfaceForegroundPatternVisible(true); } catch (Exception ex) { StingLog.Warn($"Suppressed: {ex.Message}"); }
                        }
                    }
                    ...
                    if (!string.IsNullOrEmpty(sbgPattern))
                    {
                        ...
                        {
                            ogs.SetSurfaceBackgroundPatternId(fid);
                            try { ogs.SetSurfaceBackgroundPatternVisible(true); } catch (Exception ex) { StingLog.Warn($"Suppressed: {ex.Message}"); }
                        }
                    }
                    ...
                    if (!string.IsNullOrEmpty(cfgPattern))
                    {
                        ...
                        {
                            ogs.SetCutForegroundPatternId(fid);
                            try { ogs.SetCutForegroundPatternVisible(true); } catch (Exception ex) { StingLog.Warn($"Suppressed: {ex.Message}"); }
                        }
                    }
                    ...
                    if (!string.IsNullOrEmpty(cbgPattern))
                    {
                        ...
                        if (fid != ElementId.InvalidElementId)
                        {
                            ...
                            try { ogs.SetCutBackgroundPatternVisible(true); } catch (Exception ex) { StingLog.Warn($"Suppressed: {ex.Message}"); }
                        }
                    }
        ...
        internal static void ApplyLinkOverrides(Document doc, View view, ViewStylePack pack, PackApplyResult r)
        {
            ...
            foreach (var kv in pack.LinkOverrides)
            {
                try
                {
                    ...
                    {
                        try { view.SetCategoryHidden(new ElementId(BuiltInCategory.OST_RvtLinks), true); } catch (Exception ex) { StingLog.Warn($"Suppressed: {ex.Message}"); }
                    }
        ...
        public static void ApplyPresetOverrides(Document doc, View view, List<PresetCategoryOverride> overrides, PackApplyResult r)
        {
            ...
            foreach (var o in overrides)
            {
                ...
                try
                {
                    ...
                    {
                        try { view.SetCategoryHidden(catId, !o.Visible.Value); } catch (Exception ex) { StingLog.Warn($"Suppressed: {ex.Message}"); }
                    }
