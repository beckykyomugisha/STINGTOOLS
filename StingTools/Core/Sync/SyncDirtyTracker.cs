...
namespace StingTools.Core.Sync
{
    internal static class SyncDirtyTracker
    {
        ...
        /// </summary>
        internal static void Mark(string docGuid, IEnumerable<long> elementIds)
        {
        ...
        /// </summary>
        internal static bool IsDue(string docGuid)
        {
        ...
        /// either way.
        /// </summary>
        internal static List<long> Drain(string docGuid)
        {
        ...
        internal static int PendingCount(string docGuid)
        {
