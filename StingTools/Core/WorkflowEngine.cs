    ...
    internal static class WorkflowEngine
    {
        ...
        private static IExternalCommand ResolveCommand(string tag)
        {
            switch (tag)
            {
                ...
                case "Healthcare_PharmacyRecert":    return new Commands.Healthcare.HealthcarePharmacyRecertCommand();
                case "Healthcare_CobieClinical":     return new Commands.Healthcare.HealthcareCobieClinicalExportCommand();
