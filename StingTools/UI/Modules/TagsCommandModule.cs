...
namespace StingTools.UI.Modules
{
    internal sealed class TagsCommandModule : ICommandModule
    {
        public void Register(CommandRegistry registry)
        {
            ...
            registry.Register("Sheet_DisciplinesReload", app => StingCommandHandler.RunCommandPublic<Commands.Drawing.SheetDisciplineReloadCommand>(app));
            registry.Register("Sheet_Reorder", app => StingCommandHandler.RunCommandPublic<Commands.Drawing.SheetReorderCommand>(app));
