...
- ~~**Data-driven Auto-place category checklist.**~~ **Closed (Phase 224)** —
...
- ~~**PlacementRule push-to-family-types fields.**~~ **Closed (Phase 224)** —
...
- ~~**StandardRef ↔ ApplicableStandards.**~~ **Closed (Phase 224)** —
