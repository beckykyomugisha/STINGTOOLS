...
**62 rows. One label. Every row Spaces=0. Type=Text for all calc values.** (now includes ASS_STATUS_TXT - near-universal, 71% of families.)
...
| 41 | T7 | Show T7 - Installation - ASS_INSTALL_DATE_TXT | `if(TAG_PARA_STATE_7_BOOL, ASS_INSTALL_DATE_TXT, "")` | Installed: |  | no |
| 42 | T7 | Show T7 - Installation - CST_INSTALL_HRS_DISP_TXT | `if(TAG_PARA_STATE_7_BOOL, CST_INSTALL_HRS_DISP_TXT, "")` | Hrs: | h | no |
| 43 | T7 | Show T7 - Installation - ASS_CST_INSTALL_UGX_NR | `if(TAG_PARA_STATE_7_BOOL, ASS_CST_INSTALL_UGX_NR, "")` | @ | UGX | YES |
| 44 | T8 | Show T8 - Clash - Triage Severity | `if(TAG_PARA_STATE_8_BOOL, CLASH_TRIAGE_SEVERITY_NR_DISP_TXT, "")` | Sev: | /5 | no |
| 45 | T8 | Show T8 - Clash - Triage Category | `if(TAG_PARA_STATE_8_BOOL, CLASH_TRIAGE_CATEGORY_TXT, "")` |  |  | no |
| 46 | T8 | Show T8 - Clash - Resolution Status | `if(TAG_PARA_STATE_8_BOOL, CLASH_RESOLUTION_STATUS_TXT, "")` | Res: |  | YES |
| 47 | T8 | Show T8 - Coordination - ASS_CRITICALITY_RATING_NR | `if(TAG_PARA_STATE_8_BOOL, ASS_CRITICALITY_RATING_NR, "")` | Crit: | /5 | no |
| 48 | T8 | Show T8 - Coordination - ASS_ZONE_TXT | `if(TAG_PARA_STATE_8_BOOL, ASS_ZONE_TXT, "")` | Zone: |  | no |
| 49 | T8 | Show T8 - Coordination - ASS_LVL_COD_TXT | `if(TAG_PARA_STATE_8_BOOL, ASS_LVL_COD_TXT, "")` | Lvl: |  | YES |
| 50 | T9 | Show T9 - As-built - Deviation | `if(TAG_PARA_STATE_9_BOOL, ASBUILT_DEVIATION_MM_DISP_TXT, "")` | Δ: | mm | no |
| 51 | T9 | Show T9 - As-built - Capture Date | `if(TAG_PARA_STATE_9_BOOL, ASBUILT_CAPTURE_DATE_TXT, "")` | on |  | no |
| 52 | T9 | Show T9 - Health Score | `if(TAG_PARA_STATE_9_BOOL, HEALTH_SCORE_LAST_NR_DISP_TXT, "")` | Health: | /100 | YES |
| 53 | T9 | Show T9 - Warranty & quality - ASS_WARRANTY_PARTS_TXT | `if(TAG_PARA_STATE_9_BOOL, ASS_WARRANTY_PARTS_TXT, "")` | Parts: |  | no |
| 54 | T9 | Show T9 - Warranty & quality - ASS_WARRANTY_LABOR_TXT | `if(TAG_PARA_STATE_9_BOOL, ASS_WARRANTY_LABOR_TXT, "")` | Labor: |  | no |
| 55 | T9 | Show T9 - Warranty & quality - ASS_WARRANTY_TXT | `if(TAG_PARA_STATE_9_BOOL, ASS_WARRANTY_TXT, "")` | Terms: |  | YES |
| 56 | T10 | Show T10 - Compliance - IFC PSet Override | `if(TAG_PARA_STATE_10_BOOL, IFC_PSET_OVERRIDE_TXT, "")` | IFC: |  | no |
| 57 | T10 | Show T10 - Compliance - ACC Issue | `if(TAG_PARA_STATE_10_BOOL, ACC_ISSUE_ID_TXT, "")` | ACC: |  | no |
| 58 | T10 | Show T10 - Compliance - ACC Sync Status | `if(TAG_PARA_STATE_10_BOOL, ACC_SYNC_STATUS_TXT, "")` | Sync: |  | YES |
| 59 | T10 | Show T10 - Classification - ASS_UNICLASS_2015_TXT | `if(TAG_PARA_STATE_10_BOOL, ASS_UNICLASS_2015_TXT, "")` | Uniclass: |  | no |
| 60 | T10 | Show T10 - Classification - ASS_KEYNOTE_TXT | `if(TAG_PARA_STATE_10_BOOL, ASS_KEYNOTE_TXT, "")` | Key: |  | no |
| 61 | T10 | Show T10 - Classification - ASS_MODEL_REF_TXT | `if(TAG_PARA_STATE_10_BOOL, ASS_MODEL_REF_TXT, "")` | Ref: |  | YES |
| 62 | T10 | Show T10-Ph179 - Trace Seq | `if(TAG_PARA_STATE_10_BOOL, ASS_TRACE_SEQ_NR_DISP_TXT, "")` | Trc: |  | YES |
