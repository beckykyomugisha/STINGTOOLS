...
- **Total IExternalCommand classes**: **1734**
- **Reached by a dispatch layer**: **1702**
...
The four buckets partition all 1734; the script fails if they stop adding up.

**+3 since 2026-09-14**, all reached: `TitleBlock_InspectLock`,
`TitleBlock_Unlock` and `TitleBlock_InspectFields` — PRJ_TB_LOCK_BOOL had six readers that refuse to act
