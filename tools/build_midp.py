...
R = [
    ...
    ('Z-513', 'Contractor', 'Asset data capture: serial numbers and installation dates', 'Schedule', '3.1 Construction', '400', 'XLSX', 'S2', 'Shared', 'M12-M43', 'Contractor', 'TIDP-C', 'Required for LOD 500; reported monthly from the first month of construction'),
    ('Z-514', 'Information Management', 'Asset data completeness report', 'Report', '3.1 Construction', '400', 'XLSX/PDF', 'S2', 'Shared', 'M12-M43', 'Information Manager', 'TIDP-Z', 'Monthly'),
    ...
    ('M-700', 'Mechanical', 'As-built MEP model', 'Model', '3.3 Deliverable D', '500', 'RVT/IFC', 'A1', 'Published', 'M45', 'MEP lead', 'TIDP-M', 'Includes asset data'),
