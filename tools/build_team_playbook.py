...
table(['Organisation', 'Role', 'Recipient'],
      [['The Church — Special Projects', 'Appointing Party', '[FILL]'],
       ...
       ['Symbion Consulting Group Studios', 'Information Manager', 'Mayanja Davis'],
...
table(['Role', 'Held by', 'Responsible for'],
      [['Appointing Party', 'The Church', 'Exchange information requirements; acceptance of each deliverable'],
       ...
       ['Information Manager', 'Symbion', 'The CDE, BEP, MIDP and standards; the quality gate; federation and clash management; registers, transmittals and handover data'],
