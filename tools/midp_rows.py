...
row('Z-001', IM, 'ZZ', 'Master Information Delivery Plan', 'Schedule', 'SH', MOB, 'n/a', 'XLSX', 'A1', 'Published', 0, 0, 'Information Manager', 'TIDP-Z', 2, 'N', 'N', 'N', 'Both', 'Type Document → Schedule; reference SH-Z-0001', 'Aggregated from all TIDPs; monthly and per drop')
...
row('Z-003', IM, 'ZZ', 'Responsibility matrix (RACI)', 'Schedule', 'SH', MOB, 'n/a', 'XLSX', 'A1', 'Published', 0, 0, 'Information Manager', 'TIDP-Z', 2, 'N', 'N', 'N', 'Both', 'June ref Z-002; reissued with P02 codes', 'Reference SH-Z-0002')
...
row('Z-005', IM, 'ZZ', 'Originator code register', 'Schedule', 'SH', MOB, 'n/a', 'XLSX', 'A1', 'Published', 0, 0, 'Lead Appointed Party', 'TIDP-Z', 2, 'Y', 'N', 'N', 'Aug P01', 'Responsible: Appointing Party → Lead Appointed Party (B-02)', 'Required before any container is numbered; 3-character codes')
row('Z-006', 'All disciplines', 'ZZ', 'Task Information Delivery Plan (one per appointed party)', 'Schedule', 'SH', MOB, 'n/a', 'XLSX', 'S3', 'Shared', 0, 0, 'Task Team Managers', 'TIDP-ALL', 2, 'N', 'N', 'N', 'Aug P01', '', 'Returned to the Information Manager; merged into this MIDP')
row('Z-007', IM, 'ZZ', 'Standards reconciliation schedule (BEP 4.1.3)', 'Schedule', 'SH', MOB, 'n/a', 'XLSX/PDF', 'S3', 'Shared', 0, 8, 'All disciplines', 'TIDP-Z', 2, 'Y', 'N', 'N', 'Aug P01', 'End month set to M8: closed before Technical Design', 'Opened at mobilisation; closed before Stage 2.3')
...
row('Z-009', IM, 'ZZ', 'Level and grid register', 'Schedule', 'SH', MOB, 'n/a', 'XLSX/PDF', 'A1', 'Published', 0, 0, 'Lead Appointed Party', 'TIDP-Z', 2, 'Y', 'N', 'N', 'Aug P01', '', 'Reference SH-Z-0003')
row('Z-011', IM, 'ZZ', 'Software and version register', 'Schedule', 'SH', MOB, 'n/a', 'XLSX', 'A1', 'Published', 0, 0, 'All parties', 'TIDP-Z', 3, 'N', 'N', 'N', 'Aug P01', '', 'Revit 2025 locked project-wide')
...
row('Z-024', IM, 'ZZ', 'Drawing register, transmittal and notice templates', 'Document', 'IE', MOB, 'n/a', 'XLSX/DOCX', 'A1', 'Published', 0, 0, 'Information Manager', 'TIDP-Z', 3, 'N', 'N', 'N', 'Jun P01', 'June templates carried; Uniclass column replaced by CSI section (E-05)', '')
...
row('A-101', 'Architecture', 'ZZ', 'Deliverable A drawing set', 'Drawing', 'DR', DA, '200', 'PDF/DWG', 'S3', 'Shared', 1, 1, 'Architecture lead', 'TIDP-A', 2, 'N', 'N', 'N', 'New P02', 'Added: Playbook 6.1 lists a Deliverable A drawing set that no MIDP carried', '')
...
row('G-100', 'Civil and Site', '00', 'Site model and levels', 'Model', 'M3', DA, '200', 'RVT/IFC', 'S2', 'Shared', 1, 1, 'Civil lead', 'TIDP-C', 2, 'Y', 'Y', 'N', 'Both', 'Volume 00 (site-wide)', 'Site levels, access, drainage strategy; scope to confirm')
...
row('Z-111', IM, 'ZZ', 'Area schedule reconciled to the brief', 'Schedule', 'SH', DA, '200', 'XLSX/PDF', 'S3', 'Shared', 1, 1, 'Information Manager', 'TIDP-Z', 2, 'N', 'N', 'N', 'Aug P01', '', 'Gate condition')
...
row('A-201', 'Architecture', 'ZZ', 'General arrangement plans, sections and elevations (50%)', 'Drawing', 'DR', DB, '300', 'PDF/DWG', 'S2', 'Shared', 4, 4, 'Architecture lead', 'TIDP-A', 2, 'N', 'Y', 'N', 'Both', '', '')
row('A-202', 'Architecture', 'ZZ', 'Door and window schedules', 'Schedule', 'SH', DB, '300', 'PDF/XLSX', 'S2', 'Shared', 4, 4, 'Architecture lead', 'TIDP-A', 2, 'N', 'N', 'N', 'Both', 'ISO type SH (schedule) → SC (B-04)', '')
...
row('A-204', 'Architecture', 'ZZ', 'Existing conditions and removals plan', 'Drawing', 'DR', DB, '300', 'PDF/DWG', 'S2', 'Shared', 4, 4, 'Architecture lead', 'TIDP-A', 2, 'N', 'N', 'N', 'Aug P01', '', 'Demolition classification is a manual task; BEP 10.4')
...
row('S-201', 'Structure', 'ZZ', 'General arrangement drawings (50%)', 'Drawing', 'DR', DB, '300', 'PDF/DWG', 'S2', 'Shared', 4, 4, 'Structural lead', 'TIDP-S', 2, 'N', 'Y', 'N', 'Both', '', '')
...
row('M-201', 'Mechanical', 'ZZ', 'HVAC layouts (50%)', 'Drawing', 'DR', DB, '300', 'PDF/DWG', 'S2', 'Shared', 4, 4, 'MEP lead', 'TIDP-M', 2, 'N', 'Y', 'N', 'Both', '', '')
...
row('Z-212', 'QS / Cost', 'ZZ', 'Bill of quantities (preliminary)', 'Schedule', 'CP', DB, '300', 'XLSX', 'S2', 'Shared', 4, 4, 'Quantity Surveyor', 'TIDP-Q', 2, 'Y', 'N', 'Y', 'Both', 'ISO type BQ; measurement standard [FILL] (D-03)', 'Derived from the coordinated models by the QS')
row('FF-200', 'FF&E', 'ZZ', 'FF&E and finishes register (first Fohlio exchange)', 'Schedule', 'SH', DB, '300', 'CSV/XLSX', 'S2', 'Shared', 4, 4, 'Interior Designer', 'TIDP-I', 2, 'N', 'N', 'Y', 'Aug P01', '', 'Matched on room number')
...
row('A-301', 'Architecture', 'ZZ', 'Full drawing set (100%) and details', 'Drawing', 'DR', DC, '350', 'PDF/DWG', 'S4', 'Shared', 8, 8, 'Architecture lead', 'TIDP-A', 2, 'Y', 'Y', 'N', 'Both', '', '')
...
row('S-301', 'Structure', 'ZZ', 'Structural drawing set (100%)', 'Drawing', 'DR', DC, '350', 'PDF/DWG', 'S4', 'Shared', 8, 8, 'Structural lead', 'TIDP-S', 2, 'Y', 'Y', 'N', 'Both', '', '')
...
row('M-301', 'Mechanical', 'ZZ', 'HVAC drawing set (100%)', 'Drawing', 'DR', DC, '350', 'PDF/DWG', 'S4', 'Shared', 8, 8, 'MEP lead', 'TIDP-M', 2, 'Y', 'Y', 'N', 'Both', '', '')
row('M-302', 'Mechanical', 'ZZ', 'HVAC load and sizing schedules', 'Schedule', 'SH', DC, '350', 'PDF/XLSX', 'S4', 'Shared', 8, 8, 'MEP lead', 'TIDP-M', 2, 'Y', 'N', 'N', 'Jun P01', 'June ref M-300b restored', '')
row('M-303', 'Mechanical', 'ZZ', 'BMS point-naming convention and point data on serviceable elements', 'Schedule', 'SH', DC, '350', 'XLSX', 'S3', 'Shared', 8, 8, 'MEP lead', 'TIDP-M', 2, 'N', 'N', 'N', 'New P02', 'Added (BEP 11.3)', 'Agreed with the controls contractor')
...
row('FF-300', 'FF&E', 'ZZ', 'FF&E specifications and schedule', 'Schedule', 'SH', DC, '350', 'XLSX/PDF', 'S4', 'Shared', 8, 8, 'Interior Designer', 'TIDP-I', 2, 'Y', 'N', 'Y', 'Both', '', 'Reconciled to Fohlio')
...
row('Z-410', IM, 'ZZ', 'Conformed set', 'Drawing', 'DR', CON, '350', 'PDF/DWG', 'A1', 'Published', 11, 11, 'Lead Appointed Party', 'TIDP-Z', 2, 'Y', 'Y', 'N', 'Both', 'June ref Z-401', 'Addenda incorporated; superseded revisions archived')
...
row('Z-512', 'Contractor', 'ZZ', 'As-built capture (progressive)', 'Model', 'M3', C31, '400', 'RVT/IFC', 'S2', 'Shared', 12, 43, 'Contractor', 'TIDP-W', 2, 'Y', 'Y', 'N', 'Aug P01', '', 'Clouded changes in official documentation; current to within one month')
row('Z-513', 'Contractor', 'ZZ', 'Asset data capture (tiered schedule, BEP 14)', 'Schedule', 'SH', C31, '400', 'XLSX', 'S2', 'Shared', 12, 47, 'Contractor', 'TIDP-W', 2, 'Y', 'Y', 'Y', 'Aug P01', 'End month M43 → M47: capture continues through FF&E installation', 'Tier A serialised plant, B maintainable devices, C warranted fabric')
...
row('Z-516', IM, 'ZZ', 'Revision register', 'Schedule', 'SH', C31, '400', 'XLSX', 'S2', 'Shared', 12, 43, 'Information Manager', 'TIDP-Z', 3, 'N', 'N', 'N', 'Jun P01', 'June ref Z-512 restored', 'Clouds and revision schedules')
...
row('M-520', 'Mechanical', 'ZZ', 'Commissioning point list (Niagara)', 'Schedule', 'SH', C31, '400', 'CSV', 'S2', 'Shared', 40, 40, 'MEP lead', 'TIDP-M', 2, 'Y', 'N', 'Y', 'Both', '', 'Produced from the model for the controls contractor')

# ── 3.2 FF&E ────────────────────────────────────────────────────────────────
row('FF-600', 'FF&E', 'ZZ', 'FF&E final schedule and procurement record', 'Schedule', 'SH', C32, '400', 'XLSX', 'A1', 'Published', 44, 47, 'Interior Designer', 'TIDP-I', 2, 'Y', 'N', 'Y', 'Both', 'Month M43 → M44–M47 (A-01)', 'Reconciled item by item')
row('FF-601', 'FF&E', 'ZZ', 'Installed FF&E and finishes reconciliation report (model vs Fohlio)', 'Report', 'RP', C32, '400', 'XLSX/PDF', 'S2', 'Shared', 47, 47, 'Information Manager', 'TIDP-I', 2, 'Y', 'N', 'Y', 'New P02', 'Added (Playbook 6.7 exit criteria)', 'No unlinked items; O&M data collected in Fohlio')
...
row('Z-700', IM, 'ZZ', 'COBie 2.4 handover dataset — CONDITIONAL on Owner instruction', 'Schedule', 'SH', DD, '500', 'XLSX', 'A1', 'Published', 48, 49, 'Information Manager', 'TIDP-Z', 1, 'N', 'N', 'Y', 'Both', 'Marked conditional (D-01): excluded from the base services in proposal 2.2', 'Produced only if instructed as an additional service')
...
row('Z-702', IM, 'ZZ', 'Reconciled building management system point register (digital-twin baseline)', 'Schedule', 'SH', DD, '500', 'CSV/PDF', 'A1', 'Published', 49, 49, 'Information Manager', 'TIDP-Z', 1, 'Y', 'N', 'Y', 'Both', 'Month M45 → M49', 'Model reconciled to the live Niagara station')
...
row('Z-704', IM, 'ZZ', 'Final transmittal and project archive', 'Document', 'IE', DD, '500', 'PDF', 'A1', 'Archived', 49, 49, 'Information Manager', 'TIDP-Z', 1, 'Y', 'N', 'N', 'Both', 'June ref Z-703; ISO type TR', 'Days 50 to 60')
...
row('Z-706', IM, 'ZZ', 'Final drawing register', 'Schedule', 'SH', DD, '500', 'XLSX/PDF', 'A1', 'Published', 49, 49, 'Information Manager', 'TIDP-Z', 2, 'N', 'N', 'N', 'New P02', 'Added (Playbook 6.8 deliverables)', '')
